...
<div class="trends">
	<div class="trends_background"
		style="background-image: url(resources/images/trends_background.jpg)"></div>
			...
			<div class="col-lg-3">
				<div class="trends_container">
					...
					<div class="trends_text">
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing Donec
							et.</p>
					</div>
							...
							<div class="owl-item">
								<div class="trends_item is_new">
									<div
										...
										<img src="resources/${t.getImage()}" alt="">
									</div>
									<div class="trends_content">
										...
										<div class="trends_info clearfix">
											<div class="trends_name">
												<a href="product?id=${t.getId()}">${t.getTitle()}</a>
											</div>
										</div>
										<div class="trends_price">
											<fmt:formatNumber value="${hn.getPrice()}" type="number"
												maxIntegerDigits="8" />
										</div>
									</div>
								</div>
